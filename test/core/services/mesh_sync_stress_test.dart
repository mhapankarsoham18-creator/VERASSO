...
void main() {
  ...
  group('MeshSyncManager Stress & Reliability Tests', () {
    test('Collision Detection: Prevents immediate duplicate requests', () async {
      ...
      verify(
        mockMeshService.broadcastPacket(MeshPayloadType.packetRequest, any),
      ).called(1);
    ...
    test(
      ...
      () async {
        ...
        verify(
          mockMeshService.broadcastPacket(

...
void main() {
  group('Widget Tests - Core Components', () {
    ...
    testWidgets('error message displays on failure', (
      WidgetTester tester,
    ) async {
  ...
  group('Navigation Tests', () {
    ...
    testWidgets('back button works', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            appBar: AppBar(title: Text('Screen'), leading: BackButton()),
            body: Text('Content'),
          ),
        ),
      );
  ...
  group('UI State Tests', () {
    testWidgets('toggle button changes state', (WidgetTester tester) async {
      ...
      await tester.tap(find.byType(ElevatedButton));
      await tester.pumpWidget(
        MaterialApp(home: Scaffold(body: Text('Following'))),
      );
    ...
    testWidgets('text contrast is sufficient', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          ...
          home: Scaffold(body: Text('High contrast text')),
        ),
      );

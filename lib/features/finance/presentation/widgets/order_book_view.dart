...
class OrderBookView extends StatelessWidget {
  ...
  const OrderBookView({super.key, required this.bids, required this.asks});

  @override
  Widget build(BuildContext context) {
    return Row(
      children: [
        Expanded(child: _buildSide(asks, Colors.redAccent)),
        const SizedBox(width: 12),
        Expanded(child: _buildSide(bids, Colors.greenAccent)),
      ],
    );
  }

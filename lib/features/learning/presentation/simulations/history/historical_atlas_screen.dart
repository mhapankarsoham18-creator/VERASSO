  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var route in routes) {
      ...
      if (route.points.isNotEmpty) {
        path.moveTo(
          route.points[0].dx * size.width,
          route.points[0].dy * size.height,
        );
...
class _HistoricalAtlasScreenState extends State<HistoricalAtlasScreen>
  ...
  final List<TradeRoute> _routes = [
    ...
    TradeRoute(
      name: 'Nile Trade',
      region: HistRegion.egypt,
      points: [const Offset(0.5, 0.1), const Offset(0.5, 0.9)],
    ),
    TradeRoute(
    ...
    TradeRoute(
      name: 'Royal Road',
      region: HistRegion.persia,
      points: [const Offset(0.1, 0.4), const Offset(0.9, 0.4)],
    ),
    TradeRoute(
      name: 'Tigris-Euphrates',
      region: HistRegion.mesopotamia,
      points: [const Offset(0.4, 0.2), const Offset(0.6, 0.8)],
    ),
    TradeRoute(
      name: 'Inca Roads',
      region: HistRegion.americas,
      points: [const Offset(0.2, 0.2), const Offset(0.2, 0.8)],
    ),
  ];
      ...
      _events
          .where(
            (e) =>
                ...
                (_selectedRegion == HistRegion.rome &&
                    e.region == HistRegion.italy),
          )
          .toList()
                      ...
                      Positioned(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              _selectedRegion.name.toUpperCase(),
                              style: const TextStyle(
                                fontWeight: FontWeight.bold,
                              ),
                            ),

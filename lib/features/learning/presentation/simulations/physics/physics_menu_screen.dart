            ...
            children: [
              ...
              _buildSimList(context, [
                ...
                _SimItem(
                  ...
                  () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => const ProjectileMotionSimulation(),
                    ),
                  ),
                ),
              ]),
              ...
              _buildSimList(context, [
                _SimItem(
                  ...
                  () => Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => const GravityLabScreen()),
                  ),
                ),
                _SimItem(
                  'Spring System',
                  ...
                  () => Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => const SpringLabScreen()),
                  ),
                ),
                _SimItem(
                  'Escape Velocity',
              ...
              _buildSimList(context, [
                ...
                _SimItem(
                  ...
                  () => Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => const WaveLabScreen()),
                  ),
                ),
                _SimItem(
                  'Doppler Effect',
                  ...
                  () => Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => const DopplerLabScreen()),
                  ),
                ),
              ]),
              // Optics
              ...
              _buildSimList(context, [
                _SimItem(
                  ...
                  () => Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => const CircuitLabScreen()),
                  ),
                ),
              ]),
              // Thermodynamics
